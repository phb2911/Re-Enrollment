...
function displayReportByLevel(&$db, $cid, $campName, $units){
...
?>
        ...
        <table class="headder" style="width: 100%; border-collapse: collapse;">
            <tr>
                <td style="width: 100%;">
                    <span style="font-weight: bold; font-size: 21px;">Relatório de Rematrícula por Estágio</span>
...
<?php
            ...
            $q = "SELECT COUNT(*) AS Total, levels.Name, studentCountByLevel(classes.Level, $cid, $uid, 1) AS Enrolled " .
                     "FROM students JOIN classes ON students.Class = classes.ID JOIN levels ON classes.Level = levels.ID " .
                     "WHERE classes.Campaign = $cid AND classes.School = $uid GROUP BY classes.Level ORDER BY Name";
