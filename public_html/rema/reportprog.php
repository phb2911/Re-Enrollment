...
<head>
    <title>YCG Rema - Relatório Por Programa</title>
    ...
    <div class="main">
        ...
        <div id="divHeadder" style="background-color: #61269e;">
            ...
            <div style="color: white; padding: 5px 0 5px 10px;">
                <form id="frmChangeCamp" method="post" action="reportprog.php">
                Campanha: &nbsp;
...
?>
            ...
            <div class="panel">
                ...
                <span style="font-weight: bold;">Relatório - Rematrícula Por Programa</span>
                <hr/>
...
<?php } ?>
                            <img src="<?php echo IMAGE_DIR; ?>print.png" title="Versão para impressão" style="cursor: pointer; vertical-align: bottom;" onclick="window.open('printrept.php?t=8&cid=<?php echo $cid . $rptQ; ?>', '_blank', 'toolbar=no,scrollbars=yes,resizable=yes,width=840,height=600');"/>
                        </td>
                    </tr>
                </table>
...
<?php
                // fetch data
                $result = $db->query("SELECT Name, studentCountByProg(ID,$cid," . $unit['ID'] . ",0) AS Total, studentCountByProg(ID,$cid," . $unit['ID'] . ",1) AS Enrolled FROM programs ORDER BY Name");
